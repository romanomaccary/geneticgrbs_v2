...
def generate_GRBs(N_grb,                                                              # number of simulated GRBs to produce
                  ...
                  remove_instrument_path=False, test_pulse_distr=False,
                  alpha_bpl=0.5, beta_bpl=1.5, F_break=1e-6, F_min=1e-10):               # other parameters         
    """
...
###################################################################################
    ...
    while (cnt<N_grb):
        ...
        lc.generate_LC_from_sde(q,a,alpha,k,t_0,alpha_bpl,beta_bpl,F_break,F_min)
        #if lc.check==0:
